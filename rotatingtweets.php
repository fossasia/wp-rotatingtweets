...
*/
	if($args['show_follow'] && !empty($user->screen_name)):
		...
		$result .= "\n<div class='follow-button'><a href='http://twitter.com/".$user->screen_name."' class='twitter-follow-button'{$shortenvariables} title='Follow @".$user->screen_name."'>".sprintf(__('Follow @%1','rotatingtweets'),$user->screen_name)."</a></div>";
	endif;
	wp_enqueue_script( 'jquery' );
