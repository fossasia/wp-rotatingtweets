...
jQuery(document).ready(function () {
    jQuery('.rotatingtweets').each(function () {
        ...
        // Take the smaller of the parent and grandparent
            ...
            rt_target_container_width = Math.min(
        ...
        // Get the size of the parent box and subtract any padding
            rt_target_width = rt_target_container_width - parseFloat(jQuery(this).css('padding-left')) - parseFloat(jQuery(this).css('padding-right'))  - parseFloat(jQuery(this).css('margin-left')) - parseFloat(jQuery(this).css('margin-right'))  - parseFloat(jQuery(this).css('border-left')) - parseFloat(jQuery(this).css('border-right')),
            rt_fit = 1,
            rotate_vars,
            rt_children_id,
            rt_tweet_height,
            ...
            newiconsize,
            rt_max_width,
            rt_resize_width_old_parent,
            rt_resize_width_old_grandparent,
            rt_resize_width_new_parent,
            rt_resize_width_new_grandparent,
            rt_resize_parent_change,
            rt_resize_grandparent_change,
            rt_resize_target_width,
            rt_resize_target_main,
            rt_resize_target_tweet,
            rt_resize_target_meta,
            rt_resize_change,
            rt_oldheight,
            rt_oldcontainerheight,
            rt_test_height,
            rt_old_box_height,
            rt_newheight;
        ...
        rt_block_id = rotate_id + ' .rtw_wide_block';
        rt_official_num = jQuery(rt_children_id).length;
        rt_children_meta_id = rotate_id + ' .rtw_meta';
        if (rt_official_num > 0) {
            ...
            rt_max_width = jQuery(rotate_id).width();
        ...
        rt_resize_target_width = jQuery(rotate_id).width();
        ...
        jQuery(window).resize(function () {
            ...
            if (rt_resize_change !== 0) {
                ...
                rt_old_box_height = jQuery(rotate_id).height();
                if (rotate_wp_debug) {
